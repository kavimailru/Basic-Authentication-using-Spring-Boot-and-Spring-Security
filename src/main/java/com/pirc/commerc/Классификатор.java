...
public class Классификатор {
    ...
    protected Классификатор.Группы группы;
    @XmlElement(name = "\u0421\u0432\u043e\u0439\u0441\u0442\u0432\u0430")
    protected Классификатор.Свойства свойства;
    @XmlElement(name = "\u0422\u0438\u043f\u044b\u0426\u0435\u043d")
    protected Классификатор.ТипыЦен типыЦен;
    @XmlElement(name = "\u041f\u043e\u0434\u043f\u0438\u0441\u0430\u043d\u0442\u044b")
    protected Классификатор.Подписанты подписанты;
     ...
     * @return
     *     possible object is
     *     {@link Классификатор.Группы }
     *     
     */
    public Классификатор.Группы getГруппы() {
        return группы;
    }
     ...
     *     
     */
    public void setГруппы(Классификатор.Группы value) {
        this.группы = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link Классификатор.Свойства }
     *     
     */
    public Классификатор.Свойства getСвойства() {
        return свойства;
    }
     ...
     *     
     */
    public void setСвойства(Классификатор.Свойства value) {
        this.свойства = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link Классификатор.ТипыЦен }
     *     
     */
    public Классификатор.ТипыЦен getТипыЦен() {
        return типыЦен;
    }
     ...
     *     
     */
    public void setТипыЦен(Классификатор.ТипыЦен value) {
        this.типыЦен = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link Классификатор.Подписанты }
     *     
     */
    public Классификатор.Подписанты getПодписанты() {
        return подписанты;
    }
     ...
     *     
     */
    public void setПодписанты(Классификатор.Подписанты value) {
